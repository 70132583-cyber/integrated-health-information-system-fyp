  ...
  async update(nurseId: string, data: any) {
    try {
      ...
      if (department !== undefined)
        nurseUpdateData.department = department || null;
      if (licenseNumber !== undefined)
        nurseUpdateData.licenseNumber = licenseNumber || null;
      if (cvData !== undefined) nurseUpdateData.cvData = cvData || null;
      if (cvFileName !== undefined)
        nurseUpdateData.cvFileName = cvFileName || null;
      if (cvFileType !== undefined)
        nurseUpdateData.cvFileType = cvFileType || null;
      if (licenseImage !== undefined)
        nurseUpdateData.licenseImage = licenseImage || null;
      if (salary !== undefined) {
        if (salary === '' || salary === null || salary === undefined) {
          nurseUpdateData.salary = null;
        } else {
          const salaryValue =
            typeof salary === 'number' ? salary : parseFloat(salary);
